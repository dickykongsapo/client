...
import { AggregationType } from '@models/time/time.models';
...
import { alarmFields } from '@models/alarm.models';
import { entityFields } from '@models/entity.models';
...
export class TelemetrySubscriber {
    ...
    public static createEntityAttributesSubscription(telemetryService: TelemetryService,
        entityId: EntityId, attributeScope: TelemetryType, keys: string[] = null): TelemetrySubscriber {
